# Classic 0.0.17a [![Build and Upload JS + WASM](https://github.com/radmanplays/classic-0.0.17a/actions/workflows/gradle.yml/badge.svg)](https://github.com/radmanplays/classic-0.0.17a/actions/workflows/gradle.yml)
