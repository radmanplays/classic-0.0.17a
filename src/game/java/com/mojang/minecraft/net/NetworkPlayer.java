...
public class NetworkPlayer extends Entity {
	...
	public void tick() {
		...
		float var6 = this.x - this.xo;
		float var2 = this.z - this.zo;
		this.yBodyRotO = this.yBodyRot;
		float var3 = (float)Math.sqrt((double)(var6 * var6 + var2 * var2));
		...
		if(var3 == 0.0F) {
			...
			var5 = var3 * 3.0F;
			var4 = -((float)Math.atan2((double)var2, (double)var6) * 180.0F / (float)Math.PI + 90.0F);
		}

		for(var6 = var4 - this.yBodyRot; var6 < -180.0F; var6 += 360.0F) {
		}
		...
		this.yBodyRot += var6 * 0.1F;

		for(var6 = this.yRot - this.yBodyRot; var6 < -180.0F; var6 += 360.0F) {
		}
